<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SuperMarket.index" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="fieldset" style="display: none" title="Login Here">
            <!-- User Name -->
            <div>
           ...
           <div>
                <asp:Button Text="Login" runat="server" ID="BtnLogin"  OnClick="BtnLogin_Click" />
                  <input type="button" runat="server" id="BtnClose" value="Close"/>
           </div>
        </div>
